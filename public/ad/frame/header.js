        ...
        <nav className="navbar navbar-static-top" role="navigation">
          ...
          <div className="navbar-custom-menu">
            <ul className="nav navbar-nav">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li className="user-footer">
                    <div>
                      ...
                      <a href="https://github.com/microlv" className="btn btn-default btn-flat" target="_blank">Followers</a>
              ...
              <li>
                <a href="/admin#/postarticle" data-toggle="control-sidebar"><i className="fa fa-edit"></i> Post-Article</a>
              </li>
            </ul>
          </div>
        </nav>
