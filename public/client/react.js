    ...
    12: [function (_dereq_, module, exports) {
      ...
      var Danger = {
        ...
        dangerouslyReplaceNodeWithMarkup: function (oldChild, markup) {
          ...
          ("production" !== "development" ? invariant(markup,
            'dangerouslyReplaceNodeWithMarkup(...): Missing markup.') : invariant(markup));
          ("production" !== "development" ? invariant(
      ...
      var LocalEventTrapMixin = {
        trapBubbledEvent: function (topLevelType, handlerBaseName) {
          ("production" !== "development" ? invariant(this.isMounted(),
            'Must be mounted to trap events') : invariant(this.isMounted()));
...
// http://www.w3.org/TR/REC-xml/#NT-Name
      ...
      function validateDangerousTag(tag) {
        if (!hasOwnProperty.call(validatedTagCache, tag)) {
          ("production" !== "development" ? invariant(VALID_TAG_REGEX.test(tag), 'Invalid tag: %s',
            tag) : invariant(VALID_TAG_REGEX.test(tag)));
        ...
        for (var propName in propTypes) {
          if (propTypes.hasOwnProperty(propName)) {
            ...
            if (error instanceof Error && !(error.message in loggedTypeFailures)) {
              ...
              var addendum = getDeclarationErrorAddendum(this);
              ("production" !== "development" ? warning(false, 'Failed propType: %s%s', error.message,
                addendum) : null);
            }
          }
        }
    ...
    112: [function (_dereq_, module, exports) {
      ...
      function createNodesFromMarkup(markup, handleScript) {
        ...
        ("production" !== "development" ? invariant(!!dummyNode,
          'createNodesFromMarkup dummy not initialized') : invariant(!!dummyNode));
